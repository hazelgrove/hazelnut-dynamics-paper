...
\judgbox{\selectEvalCtx{d}{\evalctx}{d'}}{$d$ should be evaluated as $\selectEvalCtxR{\evalctx}{d'}$}
\begin{mathpar}
\inferrule[\todo{??}]{ }{
...
\inferrule[\todo{??}]{
  ...
  \selectEvalCtx{\dhole{d}{\mvar}{\subst}{\markname}}{\dhole{\evalctx}{\mvar}{\subst}{\markname}}{d'}
}
