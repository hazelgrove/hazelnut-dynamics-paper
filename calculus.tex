...
% }
% \end{mathpar}
\caption{Type Consistency and Matched Types \todo{inconsistent}}
...
\inferrule[syn-empty-hole]{ }{
  \hsyn{\hGamma}{\hehole{u}}{\tehole}
}

\inferrule[syn-non-empty-hole]{
  \hsyn{\hGamma}{\hexp}{\htau}
}{
  \hsyn{\hGamma}{\hhole{\hexp}{u}}{\tehole}
}

\inferrule[syn-ascription]{
...
\begin{mathpar}
\inferrule[indet-empty-hole]
{ }
{\isIndet{\dehole{\mvar}{\subst}}}

\inferrule[indet-non-empty-hole]
{\isFinal{\dexp}}
