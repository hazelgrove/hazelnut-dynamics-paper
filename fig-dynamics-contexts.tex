...
\judgbox{\selectEvalCtx{\dexp}{\evalctx}{\dexp'}}{$\dexp$ is the result of filling the
hole (i.e. focus) in $\evalctx$ with $\dexp'$}
\begin{mathpar}
\inferrule[FHOuter]{ }{
...
\end{mathpar}
\CaptionLabel{Contextual Dynamics}{fig:contextual-dynamics}
\end{figure}
