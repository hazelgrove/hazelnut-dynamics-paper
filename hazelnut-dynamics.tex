...
\setcopyright{rightsretained} 
\acmJournal{PACMPL}
\acmYear{2019} \acmVolume{3} \acmNumber{POPL} \acmArticle{14} \acmMonth{1} \acmPrice{}\acmDOI{10.1145/3290327}
...
\keywords{live programming, gradual typing, contextual modal type theory, dynamic software updating, typed holes, structured editing}  %% \keywords is optional
