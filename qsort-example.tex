...
\vspace{-3px}
\caption{The type inspector provides static information about the term at the cursor. Here, it tells us that the hole should be filled by a list expression. Holes have hole (i.e. unknown) type, which  is universally consistent (see Sec.~\ref{sec:calculus} and \cite{popl-paper}).
}
