...
live feedback presented to the programmer has gaps, i.e. it flickers in and out or it goes stale whenever the program becomes incomplete. 
...
This paper confronts this \emph{gap problem} from type-theoretic first principles by developing 
\emph{a dynamic semantics for incomplete functional programs}, 
starting from the static semantics for incomplete functional programs
...
closure around each hole instance as it flows through the program. Editor services can report information from these hole closures 
to help the programmer decide how to fill the holes in the program. 
Hole closures also enable a \emph{fill-and-resume} feature that 
...
logical basis for tracking hole closures), combining these and developing additional machinery necessary 
to continue evaluation past the hole forms in a manner that admits important metatheoretic properties. 
...
%
We have mechanized this core calculus, called \HazelnutLive{}, using the Agda proof assistant.
%
We also describe a companion implementation 
