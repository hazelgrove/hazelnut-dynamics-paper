...
%
%The problem that specifically motivates this paper \IS that
Problematically,
...
%
%\IS actually seeing and writing in the editor.
...
%where \lismall{u} \IS an
where \lismall{u} serves as an
optional hole name \cite{GHCWIKI}\todo{fix citation}{}.%
