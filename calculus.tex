...
\inferrule[TAEHole]{
  ...
  \hasType{\Delta, \Dbinding{u}{\hGamma'}{\htau}}{\hGamma}{\dehole{u}{\sigma}{\markname}}{\htau}
}
...
\inferrule[TANEHole]{
  ...
  \hasType{\Delta, \Dbinding{u}{\hGamma'}{\htau}}{\hGamma}{\dhole{\dexp}{u}{\sigma}{\markname}}{\htau}
}
...
% \\
{[\dexp_1 / x]} \dehole{\mvar}{\subst}{\todo{??}}
&=&
\dehole{\mvar}{[\dexp_1 / x] \subst}{\todo{??}}
\\
{[\dexp_1 / x] \dhole{\dexp_2}{\mvar}{\subst}{\todo{??}}}
&=&
\dhole{ [ \dexp_1 / x ] \dexp_2 }{\mvar}{[\dexp_1 / x] \subst}{\todo{??}}
\end{array}
\]
\end{figure}
...
\inferrule[IEHole]
{ }
{\isIndet{\dehole{\mvar}{\subst}{\todo{??}}}}

\inferrule[INEHole]
{\isFinal{\dexp}}
{\isIndet{\dhole{\dexp}{\mvar}{\subst}{\todo{??}}}}
...
\todo{the judgmental forms are not consistent in these
rules; the contexts change. need to figure this out.}
...
\judgbox{\stepsToD{\Delta}{\dexp_1}{\dexp_2}}{under $\Delta$, $\dexp_1$
steps to $\dexp_2$}
\begin{mathpar}
\Infer{STHole}
{\stepsToD{\Delta}{\dexp_1}{\dexp_2} }
{\stepsToD{\Delta}{\dhole{\dexp_1}{\mvar}{\subst}{\todo{??}}}{\dhole{\dexp_2}{\mvar}{\subst}{\todo{??}}}}
\and
\Infer{STCast}
