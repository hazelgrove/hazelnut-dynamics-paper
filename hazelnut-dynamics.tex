...
\begin{abstract}
\cy{blurb from intro of grant below}

\noindent
Program editors are increasingly incorporating \emph{live programming
services}~\cite{DBLP:conf/icse/Tanimoto13,DBLP:journals/vlc/Tanimoto90,McDirmid:2007,burckhardt2013s}, which interleave editing with
