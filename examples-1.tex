...
\autoref{fig:grades-cell-mockup} depicts the cell containing the incomplete program that 
...
Going further, \Hazel helps programmers reason about the dynamic behavior of bound variables in scope at a hole via the \emph{live context inspector}, normally displayed  as a sidebar but shown disembodied in three different states in Fig.~\ref{fig:grades-sidebar}. 
