...
$\sigma$ over finite substitutions (i.e., environments) which map variables to internal expressions, written $[d_1/x_1, ~\cdots, d_n/x_n]$ for $n \geq 0$.}{fig:hazelnut-live-syntax}
\label{fig:HTyp}
\label{fig:HExp}
\end{figure}
