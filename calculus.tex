...
in \Figref{fig:elabSyn} inserts a cast from the assigned type to the
ascribed type.
%
...
by precisely characterizing when evaluation \emph{does} stop.  We also
establish that an essentially standard notion of type safety holds when
