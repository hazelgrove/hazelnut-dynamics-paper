...
$$
\vspace{-12px}
\CaptionLabel{Syntax of H-types, $\htau$, external H-expressions, $\hexp$, and internal H-expressions, $\dexp$.
We write $x$ to range over variables,
$u$ over hole names, and
$\sigma$ over finite substitutions (i.e., environments) which map variables to dynamic H-expressions, written $[d_1/x_1, ~\cdots, d_n/x_n]$ for $n \geq 0$.}{fig:hazelnut-live-syntax}
\label{fig:HTyp}
\label{fig:HExp}
\end{figure}
